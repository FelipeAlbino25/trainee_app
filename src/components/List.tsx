...
const List = ({ id, name, propTasks }: ListProps) => {
  ...
  return (
   <div className="
      bg-[#1C1C1C] border border-white/30 p-4 rounded-xl flex flex-col gap-4
      w-full max-w-[900px] min-w-[320px]
      max-[1280px]:max-w-[750px]
      max-[1024px]:max-w-[600px]
      max-[768px]:max-w-[500px]
      max-[640px]:max-w-[450px]
    ...
    ">
      ...
      <div className="flex justify-between items-center relative">
        ...
        <div className="relative">
          <button
            ...
            className="text-white text-xl font-bold px-1 hover:text-gray-400"
          >
            ...
          </button>
            ...
            <>
              ...
              >
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-2 hover:bg-white/10 transition text-sm text-red-700"
                >
      ...
      {tasks.map((task) => (
        <TaskComponent
          ...
          expectedFinishDate={
            task.expectedFinishDate ? new Date(task.expectedFinishDate) : undefined
          }
        />
      ))}
      ...
      >
        ...
        <div
          className={`fixed top-0 right-0 h-full w-full max-w-md bg-[#1C1C1C] p-4 shadow-lg transform transition-transform duration-300 ease-in-out ${
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className="bg-white hover:bg-black hover:text-white transition duration-300 hover:cursor-pointer text-black font-semibold py-2 px-4 rounded"
            >
              Salvar
            </button>
          </div>
      ...
      {showListModal && (
        ...
        >
          <div
            className="bg-[#1C1C1C] p-4 rounded shadow-lg w-full max-w-md relative flex flex-col gap-4"
            onClick={(e) => e.stopPropagation()}
          >
            <button
      ...
      {deleteMessage && (
        <div className="fixed top-5 left-1/2 transform -translate-x-1/2 bg-green-600 text-white px-4 py-2 rounded-md shadow-lg z-[999] transition">
          {deleteMessage}
        </div>
      )}
    </div>
